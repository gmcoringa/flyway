...
public class HiveSqlStatementBuilderFactory extends AbstractSqlStatementBuilderFactory {

	HiveSqlStatementBuilderFactory(PlaceholderReplacer placeholderReplacer) {
