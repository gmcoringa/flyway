...
public class HiveConnection extends Connection<HiveDatabase> {
	...
	HiveConnection(Configuration configuration, HiveDatabase database, java.sql.Connection connection, boolean originalAutoCommit) {
	...
	public Schema getSchema(String name) {
		return new HiveShema(jdbcTemplate, database, name);
	}
}
